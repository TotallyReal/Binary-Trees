...
public class TreeManager : MonoBehaviour, TreeViewer
{
    ...
    public event EventHandler<TreeViewer> OnRotationStarted;
    public UnityEvent<TreeViewer> UOnRotationStarted;
        ...
        sequence.SetDelay(delay)
                .OnStart(() => {
                    ...
                    if (rotationData.parentIndex == root)
                        root = -1;
                    OnRotationStarted?.Invoke(this, this);
                    UOnRotationStarted?.Invoke(this);
                })
